#!/usr/bin/env python3
"""Generate Step 3 remove_lowQ tree figure, styled identically to fig3_step3_tree."""
...
TREEFILE = os.path.join(BASE, "05_phylo", "remove_lowQ_tree.contree")
...
ax.set_title('Wenjiangduo mtDNA Fine Phylogenetic Tree (Step 3, Low-Quality Removed)', fontsize=16, pad=12)
